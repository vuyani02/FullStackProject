...
namespace FullStackProject.Migrations
{
    ...
    [Migration("20260402120000_AddBranchToScanRun")]
    partial class AddBranchToScanRun
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FullStackProject.Authorization.Roles.Role", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FullStackProject.Authorization.Users.User", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.ComplianceScore", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.RuleResult", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("RuleResults");
                });

            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.ScanRun", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.TenantActiveRule", b =>
                {
                    b.Property<int>("TenantId")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("TenantActiveRules");
                });

            modelBuilder.Entity("FullStackProject.MultiTenancy.Tenant", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("FullStackProject.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("FullStackProject.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("FullStackProject.Authorization.Roles.Role", b =>
                {
                    b.HasOne("FullStackProject.Authorization.Users.User", "CreatorUser")
                        .WithMany()
                        .HasForeignKey("CreatorUserId");

                    b.HasOne("FullStackProject.Authorization.Users.User", "DeleterUser")
                        .WithMany()
                        .HasForeignKey("DeleterUserId");

                    b.HasOne("FullStackProject.Authorization.Users.User", "LastModifierUser")
                        .WithMany()
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.ComplianceScore", b =>
                {
                    b.HasOne("FullStackProject.Domains.RepoGuardian.ScanRun", "ScanRun")
                        .WithMany()
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.Recommendation", b =>
                {
                    b.HasOne("FullStackProject.Domains.RepoGuardian.RuleResult", "RuleResult")
                        .WithMany()
                        .HasForeignKey("RuleResultId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("RuleResult");
                });
            ...
            modelBuilder.Entity("FullStackProject.Domains.RepoGuardian.ScanRun", b =>
                {
                    b.HasOne("FullStackProject.Domains.RepoGuardian.GithubRepository", "Repository")
                        .WithMany()
